...
export default function Navbar() {
  return (
    <div className='rounded-div flex items-center justify-between h-20 font-bold'>
        <Link to='/'>
            <h1 className='text-2xl'>CryptoHood</h1>
        </Link>
        ...
        <div className='hidden md:block'>
            ...
            <Link to='/signout' className='bg-button text-btnText px-5 py-2 ml-2 rounded-2xl shadow-lg hover:shadow-2xl'>Sign Out</Link>
        </div>
